...
## Overview
Jin, G., Yu, X., Chen, Y., Zhang, L., Li, J. (2023), Simultaneous hand-eye and target parameter estimation by solving 2d-3d generative point alignment problem, submitted to IEEE Trans. Autom. Sci. Eng.
